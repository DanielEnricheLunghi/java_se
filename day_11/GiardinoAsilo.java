...
alla classe dei semi da piantare e far crescere nella terra. A questo scopo, i bambini hanno messo delle piccole tazze lungo i davanzali delle finestre e hanno piantato un tipo di pianta in ogni tazza. I bambini hanno potuto scegliere i loro preferiti tra quattro tipi di semi disponibili: erba, trifoglio, ravanelli e violette. Istruzioni Il tuo compito è determinare, sulla base di uno schema, di quali piante è responsabile ogni bambino della classe dell'asilo. Ci sono 12 bambini nella classe: Alice, Bob, Charlie, David, Eve, Fred, Ginny, Harriet, Ileana, Joseph, Kincaid e Larry. Vengono piantati quattro diversi tipi di semi: Pianta Codifica del diagramma Erba G Trifoglio C Ravanello R Viola V Ogni bambino riceve quattro tazze, due per ogni fila: [window][window][window] ........................ # each dot represents a cup ........................ L'insegnante assegna le tazze ai bambini in ordine alfabetico, in base ai loro nomi, il che significa che Alice viene prima e Larry per ultimo. Ecco un diagramma di esempio che rappresenta le piante di Alice: [window][window][window] VR...................... RG...................... Nella prima fila, più vicina alle finestre, ha una violetta e un ravanello. Nella seconda fila ha un ravanello e un po' d'erba. Il tuo programma riceverà le piante da sinistra a destra, iniziando dalla fila più vicina alle finestre. Da questo, dovrebbe essere in grado di determinare quali piante appartengono a ogni studente. Ad esempio, se viene detto che il giardino si presenta così:
...
private Map<String, List<String>> mappaBambiniPiante; // final=costante tipo pi greco; static=obblighi tutto quanto
// viene dopo ad
// essere in un solo insieme(a condividere tutte le
// istanze)[la variabile è di classe e non di istanza]
