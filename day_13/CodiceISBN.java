...
public class CodiceISBN {
	...
	public static void main(String[] args) {
		...
		/*
		 * 
		 *  Il Processo di verifica ISBN-10 viene utilizzato per convalidare i numeri
		 *  di identificazione del libro. Questi normalmente contengono trattini e 
		 *  tipo: 3-598-21508-8 X ISBN Il formato ISBN-10 è di 9 cifre da (0 a 9) 
		 *  più un carattere di controllo (una cifra o un X only).
		 *  Nel caso in cui il carattere di controllo sia una X, questo rappresenta il
		 *   valore '10'. 
